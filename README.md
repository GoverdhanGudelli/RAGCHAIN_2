...
- **Lab 2**: Streamlit web app (`streamlit_api_assistant.py`) providing an interactive interface for querying API docs, running agents, and viewing traces (uses Groq for LLM and OpenAI for embeddings).
...
3. Set the main file to `streamlit_api_assistant.py`.
